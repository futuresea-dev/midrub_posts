...
add_hook(
    ...
    function ($args) {
        ...
        $get_transaction = get_instance()->base_model->get_data_where('transactions', '*', array('transaction_id' => $transaction_id));
        ...
        if ( $get_transaction ) {
            ...
            if ( (int)$get_transaction[0]['status'] === 1 ) {
                ...
                $get_plan = get_instance()->base_model->get_data_where('transactions_options', '*', array('transaction_id' => $transaction_id,'option_name' => 'plan_id'));
