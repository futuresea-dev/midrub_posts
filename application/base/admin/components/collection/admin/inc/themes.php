...
if ( !function_exists('the_admin_themes') ) {
    ...
    function the_admin_themes() {
        ...
        // List all themes
        foreach (glob(APPPATH . 'base/admin/themes/*', GLOB_ONLYDIR) as $dir) {
            ...
            if ( file_exists($dir . '/config.json') ) {
                ...
                if ( isset($config['name']) && isset($config['description']) && isset($config['version']) ) {
                    ...
                    if ( file_exists(FCPATH . 'assets/base/admin/themes/' . $theme . '/screenshot.png') ) {
                        
                        // Set screenshot
                        $screenshot = base_url('assets/base/admin/themes/' . $theme . '/screenshot.png');
