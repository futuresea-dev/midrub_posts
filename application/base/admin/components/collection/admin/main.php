...
namespace MidrubBase\Admin\Components\Collection\Admin;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN', MIDRUB_BASE_PATH . 'admin/components/collection/admin/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN_VERSION', '0.0.31');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\Admin\Controllers as MidrubBaseAdminComponentsCollectionAdminControllers;
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function init() {
        ...
        (new MidrubBaseAdminComponentsCollectionAdminControllers\Init)->view();
    ...
    public function ajax() {
        ...
        try {
            ...
            (new MidrubBaseAdminComponentsCollectionAdminControllers\Ajax)->$action();
    ...
    public function load_hooks($category) {
        ...
        $this->CI->lang->load( 'admin', $this->CI->config->item('language'), FALSE, TRUE, MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN );
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( md_the_component_variable('component') === 'admin' ) {
                    ...
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN . '/inc/admin_pages.php';

                    // Require the admin_hooks file
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_ADMIN . '/inc/admin_hooks.php';                    
