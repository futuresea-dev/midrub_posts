...
class Ajax {
    ...
    public function load_members_for_graph() {
        ...
        // Get members
        (new MidrubBaseAdminComponentsCollectionDashboardHelpers\Widgets)->load_members_for_graph();
    ...
    public function load_sales_for_graph() {
        ...
        // Get sales
        (new MidrubBaseAdminComponentsCollectionDashboardHelpers\Widgets)->load_sales_for_graph();
    ...
    public function change_widget_status() {
        ...
        (new MidrubBaseAdminComponentsCollectionDashboardHelpers\Widgets)->change_widget_status();
