...
namespace MidrubBase\Admin\Components\Collection\Dashboard\Helpers;
...
class Widgets {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD . 'models/', 'Dashboard_users_model', 'dashboard_users_model' );

        // Load the Dashboard Sales Model
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD . 'models/', 'Dashboard_sales_model', 'dashboard_sales_model' );

        // Load the Dashboard Widgets Model
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD . 'models/', 'Dashboard_widgets_model', 'dashboard_widgets_model' );
