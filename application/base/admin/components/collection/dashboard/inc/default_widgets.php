...
administrator_dashboard_set_widgets(array(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/dashboard/styles/css/members.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/dashboard/js/members.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION))
        ),
        'width' => 2
    )
...
administrator_dashboard_set_widgets(array(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/dashboard/styles/css/sales.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/dashboard/js/sales.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION))
        ),
        'width' => 2
    )
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">
                                <a href="<?php echo site_url('admin/members?p=all_members&member=') . $user['user_id']; ?>">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">
                                        <a href="<?php echo site_url('admin/members?p=all_members&member=') . $transaction['user_id']; ?>">
