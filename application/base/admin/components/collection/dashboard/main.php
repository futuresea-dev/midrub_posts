...
namespace MidrubBase\Admin\Components\Collection\Dashboard;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD', MIDRUB_BASE_PATH . 'admin/components/collection/dashboard/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION', '0.0.1');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\Dashboard\Controllers as MidrubBaseAdminComponentsCollectionDashboardControllers;
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function init() {
        ...
        (new MidrubBaseAdminComponentsCollectionDashboardControllers\Init)->view();
    ...
    public function ajax() {
        ...
        try {
            ...
            (new MidrubBaseAdminComponentsCollectionDashboardControllers\Ajax)->$action();
    ...
    public function component_info() {
        ...
        return array(
            ...
            'version' => MIDRUB_BASE_ADMIN_COMPONENTS_DASHBOARD_VERSION,
