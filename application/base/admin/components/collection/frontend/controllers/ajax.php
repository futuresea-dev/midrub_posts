...
namespace MidrubBase\Admin\Components\Collection\Frontend\Controllers;
...
use MidrubBase\Admin\Components\Collection\Frontend\Helpers as MidrubBaseAdminComponentsCollectionFrontendHelpers;
...
class Ajax {
    ...
    public function __construct() {
        ...
        $this->CI->lang->load( 'frontend', $this->CI->config->item('language'), FALSE, TRUE, MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND);
    ...
    public function create_new_content() {
        ...
        // Save contents
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Contents)->save_contents();
    ...
    public function load_contents_by_category() {
        ...
        // Get contents
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Contents)->load_contents_by_category();
    ...
    public function delete_content() {
        ...
        // Delete content
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Contents)->delete_content();
    ...
    public function delete_contents() {
        ...
        // Delete contents
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Contents)->delete_contents();
    ...
    public function settings_auth_pages_list() {
        ...
        // Get auth pages
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Settings)->settings_auth_pages_list();
    ...
    public function save_frontend_settings() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Settings)->save_frontend_settings();
    ...
    public function settings_all_options() {
        ...
        // Loads options
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Settings)->settings_all_options();
    ...
    public function load_theme_templates() {
        ...
        // Loads options
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Themes)->load_theme_templates();
    ...
    public function activate_theme() {
        ...
        // Activate theme
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Themes)->activate();
    ...
    public function deactivate_theme() {
        ...
        // Deactivate theme
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Themes)->deactivate();
    ...
    public function upload_theme() {
        ...
        // Uploads theme
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Themes)->upload_theme();
    ...
    public function unzipping_zip() {
        ...
        // Extract the theme
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Themes)->unzipping_zip();
    ...
    public function new_menu_item() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Menu)->new_menu_item();
    ...
    public function save_menu_items() {
        ...
        // Save menu items
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Menu)->save_menu_items();
    ...
    public function get_menu_items() {
        ...
        // Gets menu items
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Menu)->get_menu_items();
    ...
    public function load_selected_pages() {
        ...
        // Gets selected pages
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Menu)->load_selected_pages();
    ...
    public function generate_url_slug() {
        ...
        // Generate url's slug
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Url)->generate_url_slug();
    ...
    public function save_auth_social_data() {
        ...
        // Save data
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Social)->save_auth_social_data();
    ...
    public function load_multimedia() {
        ...
        // Load media
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Multimedia)->load_multimedia();
    ...
    public function upload_media_in_storage() {
        ...
        // Save data
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Multimedia)->upload_media_in_storage();
    ...
    public function delete_media_item() {
        ...
        // Delete items
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Multimedia)->delete_media_item();
    ...
    public function get_classification_data() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->get_classification_data();
    ...
    public function create_new_classification_option() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->create_new_classification_item();
    ...
    public function load_classifications() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->load_classifications();
    ...
    public function selected_classification_item() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->selected_classification_item();
    ...
    public function delete_classification() {
        ...
        // Delete item
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->delete_classification();
    ...
    public function get_classification_parents() {
        ...
        // Get parents
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->get_classification_parents();
    ...
    public function get_content_classifications() {
        ...
        // Get classifications
        (new MidrubBaseAdminComponentsCollectionFrontendHelpers\Classification)->get_content_classifications();
