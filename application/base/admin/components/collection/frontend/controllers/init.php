...
require_once APPPATH . 'base/inc/pages/administrator/frontend_pages.php';
...
class Init {
    ...
    public function view() {
        ...
        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/styles.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all'));
        ...
        if ( $this->CI->input->get('p', true) ) {
            ...
            switch ( $this->CI->input->get('p', true) ) {
                ...
                case 'editor':
                    ...
                    // Set styles
                    md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/multimedia.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all'));
                    ...
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/frontend/js/editor.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION)));

                    // Set views params
                    set_admin_view(

                        $this->CI->load->ext_view(
                            MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views',
                            'editor',
                            array(),
                            true
                        )
                                ...
                                if ( $contents_categories ) {
                                    ...
                                    foreach ( $contents_categories as $contents_category ) {
                                        ...
                                        if ( $category_slug[0] === $this->CI->input->get('p', true) ) {
                                            ...
                                            // Set js links
                                            md_set_js_urls(array(base_url('assets/base/admin/components/collection/frontend/js/contents-list.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION)));
                                    ...
                                    foreach ( $frontend_pages as $frontend_page ) {
                                        ...
                                        if ( $page_slug[0] === $this->CI->input->get('p', true) ) {
                                            ...
                                            if ( $this->CI->input->get('p', true) === 'settings' ) {
                                                ...
                                                $frontend_settings_pages = the_frontend_settings_pages();                                                
                                                ...
                                                if ( $this->CI->input->get('s', true) ) {
                                                    ...
                                                    if ( $frontend_settings_pages ) {
                                                        ...
                                                        foreach( $frontend_settings_pages as $frontend_settings_page ) {
                                                            ...
                                                            if ( $slug[0] === $this->CI->input->get('s', true) ) {
                                                                ...
                                                                set_global_variable('frontend_settings_page', $slug[0]);
                                                    ...
                                                    if ( $frontend_settings_pages ) {
                                                        ...
                                                        // Set setting page as global variable
                                                        set_global_variable('frontend_settings_page', $frontend_settings_page[0]);
