 ...
 * with methods to manage the frontend's settings
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.8
...
/*
 * Settings class provides the methods to manage the frontend's settings
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.8
...
class Settings {
    ...
    /**
     * The public method save_frontend_settings saves frontend settings
     * 
     * @since 0.0.7.8
     * 
     * @return void
