...
md_set_frontend_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/themes.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/frontend/js/themes.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION))
        )  
    )
);
...
if ( !function_exists('md_get_frontend_page_themes') ) {
    ...
    function md_get_frontend_page_themes() {
        ...
        if ( $CI->input->get('directory', true) ) {
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/themes_directory.php');
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/themes.php');
...
md_set_frontend_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/menu.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/frontend/js/menu.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION))
        )  
    )
);
...
if ( !function_exists('md_get_frontend_page_menu') ) {
    ...
    function md_get_frontend_page_menu() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/menu_page.php');
...
md_set_frontend_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/social.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/frontend/js/social.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION))
        )  
    )
);
...
if ( !function_exists('md_get_frontend_page_social_access') ) {
    ...
    function md_get_frontend_page_social_access() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/auth_social.php'); 
...
md_set_frontend_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/frontend/styles/css/settings.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/frontend/js/settings.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION))
        )  
    )
);
...
if ( !function_exists('md_get_frontend_page_settings') ) {
    ...
    function md_get_frontend_page_settings() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/settings/main.php');
...
if ( !function_exists('get_frontend_member_access_settings') ) {
    ...
    function get_frontend_member_access_settings() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/settings/general.php');
...
if ( !function_exists('frontend_settings_header') ) {
    ...
    function frontend_settings_header() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/settings/header.php');
...
if ( !function_exists('frontend_settings_footer') ) {
    ...
    function frontend_settings_footer() {
        ...
        md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/settings/footer.php');
