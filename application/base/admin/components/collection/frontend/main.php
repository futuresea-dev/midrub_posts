...
namespace MidrubBase\Admin\Components\Collection\Frontend;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND', APPPATH . 'base/admin/components/collection/frontend/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND_VERSION', '0.0.4');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\Frontend\Controllers as MidrubBaseAdminComponentsCollectionFrontendControllers;
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function init() {
        ...
        (new MidrubBaseAdminComponentsCollectionFrontendControllers\Init)->view();
    ...
    public function ajax() {
        ...
        try {
            ...
            (new MidrubBaseAdminComponentsCollectionFrontendControllers\Ajax)->$action();
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( md_the_component_variable('component') === 'frontend' ) {
                    ...
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'inc/contents_categories.php';

                    // Require the frontend_pages file
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_FRONTEND . 'inc/frontend_pages.php';
