...
namespace MidrubBase\Admin\Components\Collection\Notifications\Controllers;

// Constants
defined('BASEPATH') OR exit('No direct script access allowed');

// Define the namespaces to use
use MidrubBase\Admin\Components\Collection\Notifications\Helpers as MidrubBaseAdminComponentsCollectionNotificationsHelpers;
...
class Ajax {
    ...
    public function create_email_template() {
        ...
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Emails)->create_email_template();
    ...
    public function update_email_template() {
        ...
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Emails)->update_email_template();
    ...
    public function get_email_template_placeholder() {
        ...
        // Get placeholders
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Emails)->get_email_template_placeholder();
    ...
    public function email_templates_load_all() {
        ...
        // Get email templates
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Emails)->email_templates_load_all();
    ...
    public function notifications_load_all_plans() {
        ...
        // Get plans
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Plans)->notifications_load_all_plans();
    ...
    public function notifications_load_selected_plans() {
        ...
        // Get selected plans
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Plans)->notifications_load_selected_plans();
    ...
    public function notifications_load_users_alert_plans() {
        ...
        // Get alert's plans
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Plans)->notifications_load_users_alert_plans();
    ...
    public function notifications_create_users_alert() {
        ...
        // Save alert
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Users_alerts)->notifications_create_users_alert();
    ...
    public function notifications_load_users_alerts() {
        ...
        // Loads alerts
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Users_alerts)->notifications_load_users_alerts();
    ...
    public function notifications_delete_users_alert() {
        ...
        // Delete alert
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Users_alerts)->notifications_delete_users_alert();
    ...
    public function notifications_delete_users_alerts() {
        ...
        // Delete alerts
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Users_alerts)->notifications_delete_users_alerts();
    ...
    public function notifications_load_all_alert_users() {
        ...
        // Load users
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\Users)->notifications_load_all_alert_users();
    ...
    public function notifications_load_system_errors() {
        ...
        // Loads system errors
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\System_errors)->notifications_load_system_errors();
    ...
    public function notifications_load_system_errors_users() {
        ...
        // Loads users
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\System_errors)->notifications_load_system_errors_users();
    ...
    public function notifications_load_system_errors_types() {
        ...
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\System_errors)->notifications_load_system_errors_types();
    ...
    public function notifications_delete_system_error() {
        ...
        // Delete system error
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\System_errors)->notifications_delete_system_error();
    ...
    public function notifications_delete_system_errors() {
        ...
        (new MidrubBaseAdminComponentsCollectionNotificationsHelpers\System_errors)->notifications_delete_system_errors();
