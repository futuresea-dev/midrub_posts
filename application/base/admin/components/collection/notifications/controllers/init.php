...
class Init {
    ...
    public function view() {
        ...
        md_set_component_variable('component_slug', 'notifications');

        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/notifications/styles/css/styles.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION), 'text/css', 'all'));
                    ...
                    if ( $page_slug[0] === $this->CI->input->get('p', true) ) {
                        ...
                        set_admin_view(
                            ...
                            $this->CI->load->ext_view(
                                MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views',
                                'main',
                                array(),
                                true
                            )
