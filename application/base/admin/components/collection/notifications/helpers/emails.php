...
namespace MidrubBase\Admin\Components\Collection\Notifications\Helpers;
...
class Emails {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'models/', 'Notifications_model', 'notifications_model' );
    ...
    public function create_email_template() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ( $this->CI->base_model->get_data_where('notifications_templates', 'template_id', array('template_slug' => $template) ) ) {
    ...
    public function update_email_template() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            // Verify if the template is already in use
            if ( $this->CI->base_model->get_data_where('notifications_templates', 'template_id', array('template_id !=' => $template_id, 'template_slug' => $template) ) ) {
            ...
            if ( $this->CI->form_validation->run() !== false && $langs ) {
                ...
                if ( $c ) {
                    ...
                    $data = array(
                        'success' => TRUE,
                        'message' => $this->CI->lang->line('notifications_templates_was_updated_successfully')
                    );
                    ...
                    $data = array(
                        'success' => FALSE,
                        'message' => $this->CI->lang->line('notifications_templates_was_not_updated_successfully')
                    );
    ...
    public function email_templates_load_all() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() !== false ) {
                ...
                $notifications_templates = $this->CI->base_model->get_data_where(
                'notifications_templates',
                'notifications_templates_meta.*, notifications_templates.template_slug',
                array(),
                array(),
                array('template_title' => $this->CI->db->escape_like_str($key)),
                array(
                    array(
                ...
                if ( $notifications_templates ) {
                    ...
                    array(),
                    array(
                        'notifications_templates_meta.template_title' => $this->CI->db->escape_like_str($key)
                    ),
                    array(
                        array(
                            'table' => 'notifications_templates_meta',
