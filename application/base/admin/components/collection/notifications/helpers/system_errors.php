...
class System_errors {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'models/', 'Notifications_alerts_model', 'notifications_alerts_model' );

        // Load the alerts language file
        $this->CI->lang->load( 'notifications_alerts', $this->CI->config->item('language'), FALSE, TRUE, MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS );
    ...
    public function notifications_load_system_errors() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() !== false ) {
                ...
                $system_errorss = $this->CI->base_model->get_data_where(
                ...
                $join,
                array(
                    'order' => array('notifications_alerts.alert_id', 'desc'),
                    'start' => ($page * $limit),
                    'limit' => $limit
                ));
    ...
    public function notifications_load_system_errors_types() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() !== false ) {
                ...
                $the_errors_types = $this->CI->base_model->get_data_where(
