...
if ( !function_exists('the_users_alert_name') ) {
    ...
    function the_users_alert_name() {
        ...
        $alert_name = the_global_variable('notifications_users_alert_name');
...
if ( !function_exists('the_users_alert_type') ) {
    ...
    function the_users_alert_type() {
        ...
        $alert_type = the_global_variable('notifications_users_alert_type');
...
if ( !function_exists('the_users_alerts_field') ) {
    ...
    function the_users_alerts_field($field_name, $field_extra=NULL, $language=NULL) {
        ...
        $alert_fields = the_global_variable('notifications_users_alert_fields');
...
if ( !function_exists('the_users_alerts_filters') ) {
    ...
    function the_users_alerts_filters($filter_name, $filter_extra=NULL) {
        ...
        $alert_filters = the_global_variable('notifications_users_alert_filters')?array_column(the_global_variable('notifications_users_alert_filters'), 'filter_value', 'filter_name'):array();

        // Verify if extra exists
        if ( $filter_extra ) {

            // Get the alert's filters
            $alert_filters = array_column(the_global_variable('notifications_users_alert_filters'), 'filter_extra', 'filter_name');
...
if ( !function_exists('the_system_errors_user') ) {
    ...
    function the_system_errors_user($user_field) {
        ...
        // Get the user
        $the_user = the_global_variable('notifications_system_errors_user')?the_global_variable('notifications_system_errors_user'):array();
