...
use MidrubBase\Admin\Components\Collection\Notifications\Classes as MidrubBaseAdminComponentsCollectionNotificationsClasses;
...
if ( !function_exists('set_admin_notifications_page') ) {
    ...
    function set_admin_notifications_page($page_slug, $args) {
        ...
        $notifications_pages = (new MidrubBaseAdminComponentsCollectionNotificationsClasses\Notifications_pages);
...
if ( !function_exists('set_admin_notifications_email_template') ) {
    ...
    function set_admin_notifications_email_template($template_slug, $args) {
        ...
        $email_templates = (new MidrubBaseAdminComponentsCollectionNotificationsClasses\Email_templates);
...
if ( !function_exists('save_admin_notifications_alert') ) {
     ...
     */
    function save_admin_notifications_alert($args) {
        
        // Call the alerts class
        $alerts = (new MidrubBaseAdminComponentsCollectionNotificationsClasses\Alerts);
