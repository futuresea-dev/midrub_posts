...
set_admin_notifications_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/notifications/styles/css/email-templates.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION), 'text/css', 'all'),
            array('stylesheet', '//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.css', 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/notifications/js/email-templates.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION)),
...
if ( !function_exists('get_admin_notifications_page_email_templates') ) {
    ...
    function get_admin_notifications_page_email_templates() {
        ...
        if ( $CI->input->get('new', true) ) {     
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/email_templates/templates_new.php');

        } else if ( $CI->input->get('template', true) ) {
            
            // Get the template's metas
            $get_template_metas = $CI->base_model->get_data_where('notifications_templates_meta',
            ...
            if ( $get_template_metas ) {
                ...
                require_once MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'inc/notifications_template.php';
                ...
                // Set template's ID
                set_global_variable('template', $template);

                // Include Email Template view
                md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/email_templates/template.php');
            
            } else {

                // Include Notifications No Data view
                md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/no_data.php');    
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/email_templates/templates_list.php');
...
set_admin_notifications_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/notifications/styles/css/users-alerts.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION), 'text/css', 'all'),
            array('stylesheet', '//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.css', 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/notifications/js/users-alerts.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION)),
            array('//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.js')
        )  
    )
);
...
if ( !function_exists('get_admin_notifications_page_users_alerts') ) {
    ...
    function get_admin_notifications_page_users_alerts() {
        ...
        if ( $CI->input->get('new', true) ) {     
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/users_alerts/alerts_new.php');

        } else if ( $CI->input->get('alert', true) ) {

            // Get the alert's fields
            $the_alert_fields = $CI->base_model->get_data_where(
            ...
            if ( $the_alert_fields ) {
                ...
                require_once MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'inc/notifications_alert.php';
                ...
                // Set alert's name
                set_global_variable('notifications_users_alert_name', $the_alert_fields[0]['alert_name']);
                
                // Set alert's type
                set_global_variable('notifications_users_alert_type', $the_alert_fields[0]['alert_type']);

                // Set alert's fields
                set_global_variable('notifications_users_alert_fields', $alert_fields);

                // Get the alert's filters
                $the_alert_filters = $CI->base_model->get_data_where(
                ...
                if ( $the_alert_filters ) {
                    ...
                    // Set alert's filters
                    set_global_variable('notifications_users_alert_filters', $the_alert_filters);                    

                }

                // Include Users alert's view
                md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/users_alerts/alert.php');
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/users_alerts/alerts_list.php');
...
set_admin_notifications_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/notifications/styles/css/system-errors.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION), 'text/css', 'all'),
            array('stylesheet', '//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.css', 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/notifications/js/errors-alerts.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION)),
            array('//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.js')
        )  
    )
);
        ...
        if ( $CI->input->get('alert', true) ) {
            ...
            if ( $the_alert_fields ) {
                ...
                if ( isset($the_alert_fields[0]['user_id']) ) {
                    ...
                    // Set user
                    set_global_variable('notifications_system_errors_user', $user);                    

                }

                // Include Error Alert view
                md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/system_errors/alert.php');
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS . 'views/system_errors/errors_list.php');
