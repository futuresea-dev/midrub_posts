 ...
 * Plugins Pages Class
 *
 * This file loads the Plugins_pages Class with properties used to displays pages
 *
 * @category Social
 * @package  Midrub
...
namespace MidrubBase\Admin\Components\Collection\Plugins\Classes;

// Constats
defined('BASEPATH') OR exit('No direct script access allowed');

/*
 * Plugins_pages class loads the general properties used to displays pages
 * 
 * @category Social
 * @package  Midrub
 * @author   Scrisoft <asksyn@gmail.com>
