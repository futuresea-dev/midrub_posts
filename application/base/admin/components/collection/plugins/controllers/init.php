...
class Init {
    ...
    public function view() {
        ...
        md_set_component_variable('component_slug', 'plugins');

        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/plugins/styles/css/styles.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_PLUGINS_VERSION), 'text/css', 'all'));
                    ...
                    if ( $where_plugins_page['p'] === $page_slug[0] ) {
                        ...
                        set_admin_view(
                            ...
                            $this->CI->load->ext_view(
                                MIDRUB_BASE_ADMIN_COMPONENTS_PLUGINS .  '/views',
                                'main',
                                array(),
                                true
                            )
