...
use MidrubBase\Admin\Components\Collection\Plugins\Classes as MidrubBaseAdminComponentsCollectionPluginsClasses;
...
if ( !function_exists('the_admin_plugins_pages') ) {
    ...
    function the_admin_plugins_pages() {
        ...
        $plugins_pages = (new MidrubBaseAdminComponentsCollectionPluginsClasses\Plugins_pages);
...
if ( !function_exists('the_admin_plugins_plugin_pages') ) {
    ...
    function the_admin_plugins_plugin_pages() {
        ...
        $plugins_plugin_pages = (new MidrubBaseAdminComponentsCollectionPluginsClasses\Plugins_plugin_pages);
