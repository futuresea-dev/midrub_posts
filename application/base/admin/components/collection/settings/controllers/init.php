...
class Init {
    ...
    public function view() {
        ...
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/settings/styles/css/settings.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION), 'text/css', 'all'));
        
        // Set Main Settings JS file
        md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/main.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));
        ...
        if ( $this->CI->input->get('p', TRUE) ) {
            ...
            switch ( $this->CI->input->get('p', TRUE) ) {
                ...
                case 'advanced':
                    ...
                    set_admin_view(
                        ...
                        $this->CI->load->ext_view(
                            MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS . 'views',
                            'advanced',
                            array(),
                            true
                        )
                ...
                case 'storage':
                    ...
                    // Set Storage JS file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/storage.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));
                ...
                case 'appearance':
                    ...
                    // Set Main Settings JS file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/settings.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));                    

                    // Get all options
                    $options = $this->CI->options->get_all_options();
                ...
                case 'coupon-codes':
                    ...
                    // Load Coupons Model
                    $this->CI->load->model('codes');

                    // Set Coupon Codes JS file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/coupon-codes.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));                       
                    ...
                    if ( $this->CI->input->post() ) {
                        ...
                        if ( $this->CI->form_validation->run() == false ) {
                            ...
                            // Set error message
                            $alert = array('sube', $this->CI->lang->line('settings_coupon_code_was_not_created'));
                            
                        } else {
                            
                            // Try to save the button
                            if ( $this->CI->codes->save_coupon( $value, $type ) ) {
                                
                                // Set success message
                                $alert = array('subi', $this->CI->lang->line('settings_coupon_code_was_created'));
                ...
                case 'affiliates-reports':
                    ...
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/referrals.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));
                ...
                case 'api-permissions':
                    ...
                    // Set Api JS file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/settings/js/api.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS_VERSION)));
