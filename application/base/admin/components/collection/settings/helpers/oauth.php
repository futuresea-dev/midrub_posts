...
class Oauth {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS . '/models/', 'Oauth_permissions_model', 'oauth_permissions_model' );
        
        // Load the api applications model
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_SETTINGS . '/models/', 'Oauth_applications_model', 'oauth_applications_model' );
