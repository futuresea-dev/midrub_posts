...
class Init {
    ...
    public function view() {
        ...
        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/support/styles/css/styles.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION), 'text/css', 'all'));
                    ...
                    if ( $page_slug[0] === $this->CI->input->get('p', true) ) {
                        ...
                        set_admin_view(
                            ...
                            $this->CI->load->ext_view(
                                MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT .  '/views',
                                'main',
                                array(),
                                true
                            )
