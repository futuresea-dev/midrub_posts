...
md_set_support_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/support/styles/css/faq.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION), 'text/css', 'all'),
            array('stylesheet', '//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.css', 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/support/js/main.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION)),
...
if ( !function_exists('md_get_support_page_faq') ) {
    ...
    function md_get_support_page_faq() {
        ...
        if ( $CI->input->get('article', true) ) {
            ...
            require_once MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'inc/categories.php';

            // Require the Articles Inc
            require_once MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'inc/articles.php';
            
            // Try to add the article in the queue if exists
            set_faq_article_data();

            // Include article view for user
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'views/article.php');

        } else {

            // Include articles view for user
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'views/articles.php');
...
md_set_support_page(
    ...
    array(
        ...
        'css_urls' => array(
            array('stylesheet', base_url('assets/base/admin/components/collection/support/styles/css/tickets.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION), 'text/css', 'all')
        ),
        'js_urls' => array(
            array(base_url('assets/base/admin/components/collection/support/js/tickets.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION))
        )  
    )
);
...
if ( !function_exists('md_get_support_page_tickets') ) {
    ...
    function md_get_support_page_tickets() {
        ...
        if ( $CI->input->get('ticket', true) ) {
            ...
            require_once MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'inc/tickets.php';
            ...
            if ( md_the_component_variable('support_single_ticket') ) {
                ...
                md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'views/ticket.php');   
            ...
            md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'views/tickets.php');
