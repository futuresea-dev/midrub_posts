...
namespace MidrubBase\Admin\Components\Collection\Support;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT', MIDRUB_BASE_PATH . 'admin/components/collection/support/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION', '0.1');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\Support\Controllers as MidrubBaseAdminComponentsCollectionSupportControllers;
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function init() {
        ...
        (new MidrubBaseAdminComponentsCollectionSupportControllers\Init)->view();
    ...
    public function ajax() {
        ...
        try {
            ...
            (new MidrubBaseAdminComponentsCollectionSupportControllers\Ajax)->$action();
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( md_the_component_variable('component') === 'support' ) {
                    ...
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'inc/support_pages.php';

                } else if (md_the_component_variable('component') === 'notifications') {

                    // Require the email_templates file
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT . 'inc/email_templates.php';
    ...
    public function component_info() {
        ...
        return array(
            ...
            'version' => MIDRUB_BASE_ADMIN_COMPONENTS_SUPPORT_VERSION,
