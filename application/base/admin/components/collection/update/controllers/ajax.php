...
use MidrubBase\Admin\Components\Collection\Update\Helpers as MidrubBaseAdminCollectionUpdateHelpers;
...
class Ajax {
    ...
    /**
     * The public method update_midrub_plugin verifies if the plugin can be updated
     * 
     * @since 0.0.8.4
     * 
     * @return void
    ...
    /**
     * The public method download_plugin_update starts to download the plugins update
     * 
     * @since 0.0.8.4
     * 
     * @return void
    ...
    /**
     * The public method extract_plugin_update extracts plugins update
     * 
     * @since 0.0.8.4
     * 
     * @return void
    ...
    /**
     * The public method start_plugin_backup backups the files to update
     * 
     * @since 0.0.8.4
     * 
     * @return void
