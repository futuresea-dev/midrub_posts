...
namespace MidrubBase\Admin\Components\Collection\Update\Controllers;
...
class Init {
    ...
    public function __construct() {
        ...
        $this->CI->lang->load( 'update', $this->CI->config->item('language'), FALSE, TRUE, MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE );

        // Load Updates Model
        $this->CI->load->ext_model( MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE . 'models/', 'Updates_model', 'updates_model' );
    ...
    public function view() {
        ...
        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/admin/components/collection/update/styles/css/styles.css?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION), 'text/css', 'all'));
        ...
        if ( $this->CI->input->get('p', true) ) {
            ...
            switch ( $this->CI->input->get('p', true) ) {
                ...
                case 'apps':
                    ...
                    // Set Apps Js file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/update/js/apps.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION)));

                    // Set views params
                    set_admin_view(

                        $this->CI->load->ext_view(
                            MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE .  'views',
                            'apps',
                            array(
                ...
                case 'user_components':
                    ...
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/update/js/user-components.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION)));
                ...
                case 'frontend_themes':
                    ...
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/update/js/frontend-themes.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION)));
                ...
                case 'plugins':
                    ...
                    // Set Plugins Js file
                    md_set_js_urls(array(base_url('assets/base/admin/components/collection/update/js/plugins.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION)));
            ...
            // Set Main Js file
            md_set_js_urls(array(base_url('assets/base/admin/components/collection/update/js/main.js?ver=' . MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION)));
            ...
            switch ( $type ) {
                ...
                case 'plugins':
                    ...
                    foreach ( $updates as $update ) {
                        ...
                        if ( is_dir(APPPATH . 'base/plugins/collection/' . $update['slug']) ) {
                ...
                case 'system':
                    ...
                    // Set update url
                    $system['update_url'] = 'https://update.midrub.com/';

                    // Set update's code requirements
                    $system['update_code'] = true;

                    // Set update's code url
                    $system['update_code_url'] = 'https://access-codes.midrub.com/';
