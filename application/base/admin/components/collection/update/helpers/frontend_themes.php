        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() === false ) {
                ...
                if ( is_dir(APPPATH . 'base/frontend/themes/' . $slug) ) {
                    ...
                    if ( !empty($theme['update_code']) && !$code ) {
                    ...
                    } else if ( !empty($theme['update_code']) && $code ) {
                    ...
                    // Get the update
                    $get_update = json_decode(get($theme['update_url'] . $update_code), true);
                    ...
                    $data = array(
                        'success' => FALSE,
                        'message' => $this->CI->lang->line('update_theme_can_not_be_updated')
                    );
                ...
                if ( is_dir(APPPATH . 'base/frontend/themes/' . $slug) ) {
                    ...
                    if ( $zip->open($zip_name) === TRUE ) {
                        ...
                        if ( file_exists($this->theme_dir . '/temp/update.json') ) {
                            ...
                            // Get files to update
                            $update = json_decode(file_get_contents($this->theme_dir . '/temp/update.json'), true);
                ...
                if ( is_dir(APPPATH . 'base/frontend/themes/' . $slug) ) {
                    ...
                    if ( file_exists($this->theme_dir . '/temp/update.json') ) {
                        ...
                        if ( isset($update['files']) ) {
                            ...
                            $data = array(
                                'success' => TRUE,
                                'message' => $this->CI->lang->line('update_theme_was_updated')
                            );
