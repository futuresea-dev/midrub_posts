...
namespace MidrubBase\Admin\Components\Collection\Update;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE', MIDRUB_BASE_PATH . 'admin/components/collection/update/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE_VERSION', '0.0.2');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\Update\Controllers as MidrubBaseAdminCollectionUpdateControllers;
