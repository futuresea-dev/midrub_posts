                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingOne">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#app-<?php echo $update['slug']; ?>" aria-expanded="true" aria-controls="app-<?php echo $update['slug']; ?>">
                                                            <?php echo $update['name'] . ' ' . $update['version']; ?>
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="app-<?php echo $update['slug']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
