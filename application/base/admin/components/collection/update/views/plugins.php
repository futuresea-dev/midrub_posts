        ...
        <div class="update-page">
            <div class="row">
                <div class="col-lg-2 col-lg-offset-1">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE . 'views/menu.php'); ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingOne">
                                                    <h4 class="panel-title">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#update-plugin-<?php echo $update['slug']; ?>" aria-expanded="true" aria-controls="update-plugin-<?php echo $update['slug']; ?>">
                                                            <?php echo $update['name'] . ' ' . $update['version']; ?>
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="update-plugin-<?php echo $update['slug']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
...
<?php md_include_component_file(MIDRUB_BASE_ADMIN_COMPONENTS_UPDATE . 'views/footer.php'); ?>