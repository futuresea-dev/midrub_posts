...
namespace MidrubBase\Admin\Components\Collection\User;

// Define the constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_USER') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_USER', MIDRUB_BASE_PATH . 'admin/components/collection/user/');
defined('MIDRUB_BASE_ADMIN_COMPONENTS_USER_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_USER_VERSION', '0.0.3');

// Define the namespaces to use
use MidrubBase\Admin\Interfaces as MidrubBaseAdminInterfaces;
use MidrubBase\Admin\Components\Collection\User\Controllers as MidrubBaseAdminComponentsCollectionUserControllers;
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function init() {
        ...
        (new MidrubBaseAdminComponentsCollectionUserControllers\Init)->view();
    ...
    public function ajax() {
        ...
        try {
            ...
            (new MidrubBaseAdminComponentsCollectionUserControllers\Ajax)->$action();
    ...
    public function load_hooks($category) {
        ...
        $this->CI->lang->load( 'user', $this->CI->config->item('language'), FALSE, TRUE, MIDRUB_BASE_ADMIN_COMPONENTS_USER );
        ...
        switch ($category) {
            ...
            case 'admin_init':
                ...
                if ( md_the_component_variable('component') === 'user' ) {
                    ...
                    require_once MIDRUB_BASE_ADMIN_COMPONENTS_USER . '/inc/user_pages.php';
