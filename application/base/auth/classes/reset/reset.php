...
class Reset {
    ...
    public function reset_password($email) {
        ...
        if ( $this->CI->base_users->get_user_ceil('email', $email ) ) {
            ...
            $user = $this->CI->base_model->get_data_where('users', 'user_id, username, first_name, last_name, status', array('email' => strtolower($email)));
            ...
            if ($add_reset) {
                ...
                $change_password = the_url_by_page_role('change_password') ? the_url_by_page_role('change_password') : site_url('auth/change-password');
