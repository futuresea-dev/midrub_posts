...
class Signup {
    ...
    public function save_user_data($args) {
        ...
        if ( (strlen($args['username']) < 6) || (strlen($args['password']) < 6) ) {
            ...
            if ( the_option('signup_confirm') AND !isset($args['status']) ) {
            ...
            if ( $user_id ) {
                ...
                if ( the_option('enable_new_user_notification') ) {
                ...
                if ( the_option('signup_confirm') ) {
                    ...
                    $confirmation = the_url_by_page_role('confirmation') ? the_url_by_page_role('confirmation') : site_url('auth/confirmation');
