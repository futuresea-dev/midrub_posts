            ...
            switch ( $this->CI->input->get('p', TRUE) ) {
                ...
                case 'success':
                    ...
                    if ( $complete_transaction ) {
                        ...
                        $transaction_data = $this->CI->base_model->get_data_where('transactions', '*', 
                            array(
                                                    ...
                                                    if ( $referral[0]->earned < 1 ) {
                                                        ...
                                                        if ( get_option('referrals_exact_gains') ) {
                                                            ...
                                                            if ( is_numeric(plan_feature('referrals_percentage_revenue', $options['plan_id'])) ) {
                                                                ...
                                                                $total = number_format( ( (plan_feature('referrals_percentage_revenue', $options['plan_id']) / 100) * $transaction_data[0]['amount']), 2);   
