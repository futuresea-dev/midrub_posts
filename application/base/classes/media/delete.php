...
class Delete {
    ...
    public function delete_file($params, $return=FALSE) {
        ...
        $media = $this->CI->base_model->get_data_where('media', '*', array('media_id' => $params['media_id'], 'user_id' => $user_id) );
        ...
        if ( $this->CI->base_model->delete('media', array('media_id' => $params['media_id'], 'user_id' => $user_id) ) ) {
            ...
            // Get user storage
            $user_storage = the_user_option('user_storage', $user_id);
            ...
            if ( !empty($delete['success']) ) {
                ...
                // Set storage
                $delete['user_storage'] = calculate_size($user_storage);
