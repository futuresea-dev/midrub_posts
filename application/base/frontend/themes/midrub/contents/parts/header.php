...
<head>
    ...
    <?php if ( get_option('frontend_theme_favicon') ): ?>
    <!-- Favicon-->
    <link rel="shortcut icon" href="<?php echo get_option('frontend_theme_favicon'); ?>" />
    <?php endif; ?>    
                ...
                <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3">
                    <h5 class="font-logo">
                        <a href="<?php echo site_url(); ?>">
                            <?php if ( get_option('frontend_theme_logo') ): echo '<img src="' . get_option('frontend_theme_logo') . '" class="logo">'; else: get_site_name(); endif; ?>
                        </a>
                    </h5>
                    <?php
                    get_menu(
