...
set_frontend_settings_page(
    'theme_midrub_theme',
    array(
        'page_name' => $CI->lang->line('theme_midrub_theme'),
        'page_icon' => '<i class="icon-grid"></i>',
        'content' => 'theme_midrub_theme',
        'css_urls' => array(),
        'js_urls' => array()  
    )
);

if ( !function_exists('theme_midrub_theme') ) {

    /**
     * The function theme_midrub_theme shows the theme settings
     * 
     * @return void
     */
    function theme_midrub_theme() {

        // Request the Settings view
        md_include_component_file(the_theme_path() . 'core/views/settings.php');
