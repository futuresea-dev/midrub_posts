...
namespace MidrubBase\Plugins;

// Constants
defined('BASEPATH') OR exit('No direct script access allowed');
defined('MIDRUB_BASE_PLUGINS') OR define('MIDRUB_BASE_PLUGINS', APPPATH . 'base/plugins/');
defined('MIDRUB_BASE_PLUGINS_VERSION') OR define('MIDRUB_BASE_PLUGINS_VERSION', '0.1');
...
class Main {
    ...
    public function ajax_init($plugin) {
        ...
        if ( file_exists(MIDRUB_BASE_PLUGINS . 'collection/' . $plugin . '/main.php') ) {
            ...
            if ( is_dir(MIDRUB_BASE_PLUGINS . 'collection/' . $plugin . '/') ) {
