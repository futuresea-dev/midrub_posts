...
class Main implements MidrubBaseUserInterfaces\Apps {
            ...
            case 'admin_init':
                ...
                add_hook(
                    ...
                    function ($args) {
                        ...
                        get_the_file(MIDRUB_BASE_USER_APPS_DASHBOARD . 'inc/admin.php');

                        // Require the Plans Inc
                        get_the_file(MIDRUB_BASE_USER_APPS_DASHBOARD . 'inc/plans.php');
    ...
    public function app_info() {
        ...
        return array(
            ...
            'update_url' => 'https://update.midrub.com/dashboard/',
            'update_code' => TRUE,
