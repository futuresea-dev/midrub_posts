...
defined('MIDRUB_BASE_USER_APPS_POSTS_VERSION') OR define('MIDRUB_BASE_USER_APPS_POSTS_VERSION', '0.1.2');
defined('MIDRUB_POSTS_FACEBOOK_GRAPH_URL') OR define('MIDRUB_POSTS_FACEBOOK_GRAPH_URL', 'https://graph.facebook.com/v7.0/');
...
class Main implements MidrubBaseUserInterfaces\Apps {
    ...
    public function app_info() {
        ...
        return array(
            ...
            'update_url' => 'https://update.midrub.com/posts/',
            'update_code' => TRUE,
