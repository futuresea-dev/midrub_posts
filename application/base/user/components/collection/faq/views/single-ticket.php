                    ...
                    <li>
                        ...
                        <ul class="list-group">
                            ...
                            if ( $tickets ) {
                                ...
                                foreach ( $tickets as $ticket_single ) {
                                    
                                    ?>
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('user/faq?p=tickets&ticket=' . $ticket_single['ticket_id']) ?>">
                                            <?php echo $ticket_single['subject']; ?>
                                        </a>
                                    </li>
                                    <?php
            ...
            <div class="col-xl-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="article">
                                        ...
                                        <?php
                                        echo !empty($ticket[0]['body'])?nl2br($ticket[0]['body']):$ticket[0]['body'];
                                        ?>   
                                    </div>
                                </div>
                ...
                <div class="comment-form">
                    <div class="comment-form-area">
                        <?php echo form_open('user/faq', array('class' => 'submit-ticket-reply', 'data-csrf' => $this->security->get_csrf_token_name())) ?>
