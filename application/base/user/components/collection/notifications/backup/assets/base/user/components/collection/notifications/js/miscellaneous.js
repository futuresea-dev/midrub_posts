/*
 * Miscellaneous Notifications JavaScript file
*/
...
jQuery(document).ready( function ($) {
    ...
    ********************************/
     ...
     * @since   0.0.8.3
     */
    Main.load_miscellaneous_by_page = function (page) {
        
        // Prepare data
        var data = {
            action: 'load_miscellaneous_by_page',
            page: page
        };

        // Make ajax call
        Main.ajax_call(url + 'user/component-ajax/notifications', 'GET', data, 'display_miscellaneous_by_page_response');
    ...
    ********************************/ 
    ...
    $(function () {
        ...
        // Load miscellaneous alerts
        Main.load_miscellaneous_by_page(1);
    ...
    $( document ).on( 'click', '.notifications-page .next-button, .notifications-page .back-button', function (e) {
        ...
        // Loads notifications
        Main.load_miscellaneous_by_page(page);
    ...
    $( document ).on( 'click', '.notifications-page .notifications-delete-alert', function (e) {
        ...
        // Prepare data
        var data = {
            action: 'delete_miscellaneous_alert',
            alert: alert_id
        };
        
        // Make ajax call
        Main.ajax_call(url + 'user/component-ajax/notifications', 'GET', data, 'delete_miscellaneous_alert_response');
    ...
    ********************************/
     ...
     * @since   0.0.8.3
     */
    Main.methods.display_miscellaneous_by_page_response = function ( status, data ) {
        ...
        if ( status === 'success' ) {
            ...
            // List all alerts miscellaneous
            for ( var n = 0; n < data.miscellaneous.length; n++ ) {

                // Unread mark
                var unread = '';

                // Verify if the miscellaneous alert is unread
                if ( data.miscellaneous[n].page_seen === null ) {
                    unread = ' class="notifications-unread-notification"';
                }
                
                notifications += '<li data-alert="' + data.miscellaneous[n].alert_id + '"' + unread + '>'
                    + '<div class="row">'
                        + '<div class="col-11">'
                            + '<a href="' + url + 'user/notifications?p=miscellaneous&alert=' + data.miscellaneous[n].alert_id + '" class="notifications-show-notification">'
                                + '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">'
                                    + '<path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.523-3.356c.329-.314.158-.888-.283-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767l-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288l1.847-3.658 1.846 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.564.564 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"/>'
                                + '</svg>'
                                + data.miscellaneous[n].name
                            + '</a>'
                        + '</div>'
                        + '<div class="col-1">'
                            + '<div class="btn-group">'
     ...
     * @since   0.0.8.3
     */
    Main.methods.delete_miscellaneous_alert_response = function ( status, data ) {
