<?php
/**
 * Notifications Errors Model
 *
 * PHP Version 7.3
 *
 * Notifications_errors_model file contains the Notifications Errors Model
 *
 * @category Social
 * @package  Midrub
...
/**
 * Notifications_errors_model class - operates the notifications alerts tables
 *
 * @since 0.0.8.3
 * 
 * @category Social
 ...
 * @link     https://www.midrub.com/
 */
class Notifications_errors_model extends CI_MODEL {
    ...
    /**
     * The public method the_errors_alerts gets all alerts from database
     *
     * @param array $args contains the query's parameters
     * 
     * @return array with results or false
     */
    public function the_errors_alerts($args) {
        ...
        if ( $query->num_rows() > 0 ) {
            ...
            if ( $errors ) {
                ...
                // Set where_in
                $this->db->where_in('notifications_alerts_fields.alert_id', $errors);  
                ...
                if ( $get_alerts->num_rows() > 0 ) {
                    ...
                    // Return response
                    return array(
                        'errors' => $get_alerts->result_array(),
                        'total' => count($errors)
                    );
    ...
    /**
     * The public method the_errors_alert gets the errors alert
     *
     * @param array $args contains the query's parameters
     * 
     * @return array with alert or false
     */
    public function the_errors_alert($args) {
...
/* End of file notifications_errors_model.php */