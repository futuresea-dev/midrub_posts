...
defined('MIDRUB_BASE_USER_COMPONENTS_TEAM_VERSION') OR define('MIDRUB_BASE_USER_COMPONENTS_TEAM_VERSION', '0.3');
    ...
    public function load_hooks( $category ) {
        ...
        switch ( $category ) {
            ...
            case 'admin_init':
                ...
                get_the_file(MIDRUB_BASE_USER_COMPONENTS_TEAM . 'inc/admin.php');            
            ...
            case 'user_init':
                ...
                // Register the hooks for pages
                get_the_file(MIDRUB_BASE_USER_COMPONENTS_TEAM . 'inc/members.php');              
