            ...
            if ($con [0]->secret) {
                ...
                try {
                    ...
                    if ( !empty($args['img']) ) {
                        ...
                        if ( strpos($args['img'][0]['body'], base_url()) !== false ) {
                            ...
                            // Get extension
                            $extension = pathinfo($args['img'][0]['body'], PATHINFO_EXTENSION);
                            ...
                            if ( $extension ) {
                                ...
                                // Save file
                                file_put_contents($filename, $args['img'][0]['body']);
                                ...
                                if ( file_exists($filename) ) {
                                    ...
                                    $mediaItem = new \Google_Service_MyBusiness_MediaItem();
                                    $mediaItem->setMediaFormat('PHOTO');
                                    $mediaItem->setSourceUrl(str_replace(site_url(), FCPATH, $filename));                               
