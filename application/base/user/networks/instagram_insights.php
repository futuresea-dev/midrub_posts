...
class Instagram_insights implements MidrubBaseUserInterfaces\Networks {
    ...
    public function get_info() {
        ...
        $types = array('insights', 'inbox', 'preview');

        if ( get_option('instagram_no_mobile') ) {
            $checked = ' checked';
            $types[] = 'post';
        }
            ...
            'extra_content' => '<div class="form-group">'
                    ...
                    . '<div class="col-lg-2 col-xs-6">'
                        . '<div class="checkbox-option pull-right">'
                            . '<input id="instagram_no_mobile" name="instagram_no_mobile" class="social-option-checkbox" type="checkbox" ' . $checked . '>'
                            . '<label for="instagram_no_mobile"></label>'
                        . '</div>'
                    . '</div>'
                . '</div>'
            . '</div>'
