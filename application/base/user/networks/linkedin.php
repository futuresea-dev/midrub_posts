...
class Linkedin implements MidrubBaseUserInterfaces\Networks {
    ...
    public function connect() {
        ...
        // Verify if user is marketing partner
        if ( get_option('linkedin_marketing_partner') ) {
        ...
        try {
            ...
            if ( get_option('linkedin_marketing_partner') ) {
                ...
                if ( isset($args['img'][0]['body']) ) {
                    ...
                    $request->registerUploadRequest->owner = 'urn:li:person:' . $user_details[0]->net_id;
                ...
                $post_body->owner = 'urn:li:person:' . $user_details[0]->net_id;
                ...
                if ( $args['url'] ) {
                    ...
                    $params['content'] = array( 
                        ...
                        'contentEntities' => array(
                            ...
                            array(
                                'entityLocation' => short_url($args['url'])
                            )
                                    ...
                                    . '<div class="row">'
                                        . '<div class="col-lg-10 col-xs-6">'
                                            . '<label for="menu-item-text-input">'
                                                . 'I am a Linkedin Marketing Partner'
                                            . '</label>'
                                        . '</div>'
                                    . '<div class="col-lg-2 col-xs-6">'
                                        . '<div class="checkbox-option pull-right">'
                                            . '<input id="linkedin_marketing_partner" name="linkedin_marketing_partner" class="social-option-checkbox" type="checkbox" ' . $checked . '>'
                                            . '<label for="linkedin_marketing_partner"></label>'
                                        . '</div>'
                                    . '</div>'
                                . '</div>'
                            . '</div>'
