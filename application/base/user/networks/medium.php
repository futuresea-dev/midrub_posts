...
class Medium implements MidrubBaseUserInterfaces\Networks {
    ...
    public function check_availability() {
        ...
        } else if ( the_option('medium_integration_tokens') ) {
    ...
    public function connect() {
        ...
        // Verify if integration token exists
        if ( the_option('medium_integration_tokens') ) {
            ...
            if ($this->CI->input->post()) {
                ...
                // Get post data
                $integration_token = $this->CI->input->post('integration_token');
                ...
                if ($this->CI->form_validation->run() !== false) {
                    ...
                    curl_setopt_array($curl, array(CURLOPT_RETURNTRANSFER => 1, CURLOPT_URL => 'https://api.medium.com/v1/me?accessToken=' . $integration_token, CURLOPT_HEADER => false));
                    ...
                    if ( $data ) {
                        ...
                        if ( isset($udata['data']['name']) ) {
                            ...
                            if ( !$this->CI->networks->get_network_data('medium', $this->CI->user_id, $id) ) {
                                ...
                                if ( $this->CI->networks->add_network('medium', $id, $integration_token, $this->CI->user_id, '', $name, $imageUrl, '') ) {
                ...
                echo $this->CI->ecl('Social_login')->content('Integration Token', '', 'Connect', $this->get_info(), 'medium', '');  
    ...
    public function post($args, $user_id = null) {
        ...
        try {
            ...
            if ( !the_option('medium_integration_tokens') ) {
                ...
                $access_token = $this->medium->exchangeRefreshToken($user_details[0]->secret);
            ...
            if ( !empty($access_token) ) {
                ...
                // Set access token
                $this->medium->setAccessToken($access_token);
            ...
            'extra_content' => '<div class="form-group">'
                    ...
                    . '<div class="col-lg-2 col-xs-6">'
                        . '<div class="checkbox-option pull-right">'
                            . '<input id="medium_integration_tokens" name="medium_integration_tokens" class="social-option-checkbox" type="checkbox" ' . $checked . '>'
                            . '<label for="medium_integration_tokens"></label>'
                        . '</div>'
                    . '</div>'
                . '</div>'
            . '</div>'
