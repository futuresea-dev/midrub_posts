...
class Youtube implements MidrubBaseUserInterfaces\Networks {
    ...
    public function get_info() {
        ...
        // Set return
        return array(
            'custom_connect' => '<i style="background-image: url(../../assets/img/youtube-icon.png); vertical-align: sub; width: 24px; height: 16px; display: inline-block;"></i>' . $this->CI->lang->line('networks_new_account'),
            'color' => '#ca3737',
