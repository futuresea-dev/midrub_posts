...
if ( !function_exists( 'composer_get_categories' ) ) {
    ...
    function composer_get_categories() {
        ...
        if ( $network === 'blogger' ) {
            ...
            $categories = array();
            $categories[] = '<option value="funny">' . $CI->lang->line('alerts_funny') . '</option>';
            $categories[] = '<option value="gifs">' . $CI->lang->line('alerts_gifs') . '</option>';
            $categories[] = '<option value="gaming">' . $CI->lang->line('alerts_gaming') . '</option>';
            $categories[] = '<option value="jokes">' . $CI->lang->line('alerts_jokes') . '</option>';
            $categories[] = '<option value="personalfinance">' . $CI->lang->line('alerts_personal_finance') . '</option>';
            $categories[] = '<option value="pics">' . $CI->lang->line('alerts_pics') . '</option>';
            $categories[] = '<option value="movies">' . $CI->lang->line('alerts_movies') . '</option>';
            $categories[] = '<option value="music">' . $CI->lang->line('alerts_music') . '</option>';
            $categories[] = '<option value="worldnews">' . $CI->lang->line('alerts_news') . '</option>';
            $categories[] = '<option value="videos">' . $CI->lang->line('alerts_videos') . '</option>';
            ...
            $categories = array();
            $categories[] = '<option value="1">' . $CI->lang->line('alerts_film_animation') . '</option>';
            $categories[] = '<option value="2">' . $CI->lang->line('alerts_autos_vehicles') . '</option>';
            $categories[] = '<option value="10">' . $CI->lang->line('alerts_music') . '</option>';
            $categories[] = '<option value="15">' . $CI->lang->line('alerts_pets_animals') . '</option>';
            $categories[] = '<option value="17">' . $CI->lang->line('alerts_sports') . '</option>';
            $categories[] = '<option value="18">' . $CI->lang->line('alerts_short_movies') . '</option>';
            $categories[] = '<option value="20">' . $CI->lang->line('alerts_gaming') . '</option>';
            $categories[] = '<option value="21">' . $CI->lang->line('alerts_videoblogging') . '</option>';
            $categories[] = '<option value="22">' . $CI->lang->line('alerts_people_blogs') . '</option>';
            $categories[] = '<option value="25">' . $CI->lang->line('alerts_news_politics') . '</option>';
            $categories[] = '<option value="27">' . $CI->lang->line('alerts_education') . '</option>';
            $categories[] = '<option value="28">' . $CI->lang->line('alerts_science_technology') . '</option>';
