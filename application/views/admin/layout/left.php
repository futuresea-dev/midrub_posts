<nav>
    <ul>
        ...
        <li<?php if ( function_exists('md_the_component_variable') ): if ( md_the_component_variable('component_slug') === 'notifications' ): echo ' class="active"'; endif; endif; ?>>
            <a href="<?php echo site_url('admin/notifications') ?>">
                <i class="icon-bell"></i><br>
                <?php echo $this->lang->line('ma2'); ?>
            </a>
        </li>        
        <li<?php if ( function_exists('md_the_component_variable') ): if ( md_the_component_variable('component_slug') === 'members' ): echo ' class="active"'; endif; endif; ?>>
