...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.start_download = function (args) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'download_app_update');
    ...
    Main.start_extract = function (args) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'extract_app_update');
    ...
    Main.start_backup = function (args) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'start_app_backup');
    ...
    ********************************/ 
     ...
     * @since   0.0.8.1
     */
    Main.methods.update_midrub_app = function ( status, data ) {
     ...
     * @since   0.0.8.1
     */
    Main.methods.download_app_update = function ( status, data ) {
     ...
     * @since   0.0.8.1
     */
    Main.methods.extract_app_update = function ( status, data ) {
    ...
    ********************************/
    ...
    $('.update-midrub').submit(function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'update_midrub_app');
