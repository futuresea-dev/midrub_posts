...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.start_download = function (args) {
        ...
        var data = {
            action: 'download_user_component_update',
            code: code,
            slug: slug
        };
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'download_user_component_update');
    ...
    Main.start_extract = function (args) {
        ...
        // Prepare data to send
        var data = {
            action: 'extract_user_component_update',
            slug: slug
        };
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'extract_user_component_update');
    ...
    Main.start_backup = function (args) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'start_user_component_backup');
    ...
    ********************************/ 
     ...
     * @since   0.0.8.2
     */
    Main.methods.update_midrub_user_component = function ( status, data ) {
     ...
     * @since   0.0.8.2
     */
    Main.methods.download_user_component_update = function ( status, data ) {
     ...
     * @since   0.0.8.2
     */
    Main.methods.extract_user_component_update = function ( status, data ) {
    ...
    ********************************/
    ...
    $('.update-midrub').submit(function (e) {
        ...
        // Prepare data to send
        var data = {
            action: 'update_midrub_user_component',
            code: code,
            slug: slug
        };
        ...
        // Make ajax call
        Main.ajax_call(url + 'admin/ajax/update', 'POST', data, 'update_midrub_user_component');
