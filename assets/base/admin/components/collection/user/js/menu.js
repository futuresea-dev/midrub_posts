            ...
            for (var l = 0; l < items.length; l++) {
                ...
                for (var s = 0; s < data.languages.length; s++) {
                    ...
                    + '<div class="form-group">'
                        ...
                        + '<div class="row">'
                            + '<div class="col-lg-12">'
                                + '<input type="text" class="form-control menu-item-text-input" id="menu-item-text-input' + l + '-' + '-' + random_number + '" placeholder="' + data.words.enter_item_name + '" value="' + name + '" data-slug="menu_item_name">'
                    ...
                    + '<div class="form-group">'
                        ...
                        + '<div class="row">'
                            ...
                            + '</div>'
                            + '<div class="col-lg-6">'
                                + '<input type="text" class="form-control menu-item-text-input menu-item-permalink" id="menu-item-permalink' + l + '-' + '-' + random_number + '" placeholder="' + data.words.item_enter_url + '" value="' + permalink + '">'
                            + '</div>'
                        + '</div>'
                        + '<div class="row">'
                            + '<div class="col-lg-12">'
                                    ...
                                    + '<div class="col-lg-12">'
                                        + '<div class="collapse multi-collapse" id="show-advanced-options-' + data.languages[s] + l + '-' + '-' + random_number + '">'
                                            + '<div class="form-group">'
                                                ...
                                                + '<div class="row">'
                                                    + '<div class="col-lg-12">'
                                                        + '<input type="text" class="form-control menu-item-description menu-item-text-input" id="menu-item-description' + l + '-' + '-' + random_number + '" placeholder="' + data.words.enter_item_description + '" value="' + description + '">'
                                                            + '<small class="form-text text-muted">'
                                                ...
                                                + '<div class="form-group">'
                                                    ...
                                                    + '<div class="row">'
                                                        + '<div class="col-lg-12">'
                                                            + '<input type="text" class="form-control menu-item-class menu-item-text-input" id="menu-item-class' + l + '-' + '-' + random_number + '" placeholder="' + data.words.enter_item_class + '" value="' + iclass + '">'
                                                            + '<small class="form-text text-muted">'
        ...
        for ( var l = 0; l < Main.available_languages.length; l++ ) {
            ...
            tabs += '<div id="' + Main.available_languages[l] + '-' + random_number + '" class="tab-pane fade' + tab_active + '" data-lang="' + Main.available_languages[l] + '">'
                        + '<div class="form-group">'
                            ...
                            + '<div class="row">'
                                + '<div class="col-lg-12">'
                                + '<input type="text" class="form-control menu-item-text-input" id="menu-item-text-input' + l + '-' + '-' + random_number + '" placeholder="' + Main.menu_item_words.enter_item_name + '" data-slug="menu_item_name">'
                                + '<small class="form-text text-muted">'
                    ...
                    + '<div class="form-group">'
                        ...
                        + '<div class="row">'
                            ...
                            + '</div>'
                        + '<div class="col-lg-6">'
                            + '<input type="text" class="form-control menu-item-text-input menu-item-permalink" id="menu-item-permalink' + l + '-' + '-' + random_number + '" placeholder="' + Main.menu_item_words.item_enter_url + '">'
                        + '</div>'
                    + '</div>'
                    + '<div class="row">'
                        + '<div class="col-lg-12">'
                                ...
                                + '<div class="col-lg-12">'
                                    + '<div class="collapse multi-collapse" id="show-advanced-options-' + Main.available_languages[l] + '-' + random_number + '">'
                                        + '<div class="form-group">'
                                            ...
                                            + '<div class="row">'
                                                + '<div class="col-lg-12">'
                                                    + '<input type="text" class="form-control menu-item-description menu-item-text-input" id="menu-item-description' + l + '-' + '-' + random_number + '" placeholder="' + Main.menu_item_words.enter_item_description + '">'
                                                    + '<small class="form-text text-muted">'
                                        ...
                                        + '<div class="row">'
                                            + '<div class="col-lg-12">'
                                                + '<input type="text" class="form-control menu-item-class menu-item-text-input" id="menu-item-class' + l + '-' + '-' + random_number + '" placeholder="' + Main.menu_item_words.enter_item_class + '">'
                                                + '<small class="form-text text-muted">'
